/**
 * Shared OpenSubtitles helpers for classic (non-module) content scripts.
 * Mirrors the ES module API in lib/subtitles.js.
 */
(() => {
  ...
  function slugifyMovieName(title) {
    return String(title || '')
      .normalize('NFD')
      .replace(/[\u0300-\u036f]/g, '')
      .replace(/[^a-zA-Z0-9]+/g, '+')
  ...
  globalThis.FilmwebHelperSubtitles = {
